...
$host   = 'localhost';     // servidor MySQL (XAMPP corre em localhost)
$dbname = 'sylviartes';    // nome da BD criada no phpMyAdmin
$user   = 'root';          // utilizador por defeito do MySQL no XAMPP
$pass   = '';              // password vazia por defeito (XAMPP)
